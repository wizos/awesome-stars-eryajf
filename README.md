...
*   [awaLiny2333/LinysBrowser\_NEXT](https://github.com/awaLiny2333/LinysBrowser_NEXT) - A basic browser on HarmonyOS NEXT!
...
*   [barkure/Orayo](https://github.com/barkure/Orayo) - A modern Xray client for Windows.
...
*   [wsxyeah/HarmonySU](https://github.com/wsxyeah/HarmonySU) - 鸿蒙模拟器 root 工具，方便调试。

*   [weolar/miniblink132](https://github.com/weolar/miniblink132) - a lite browser kernel
...
*   [callng/NewFuckMarketAds](https://github.com/callng/NewFuckMarketAds) - 去他妈的小米应用商店广告

*   [Q7DF1/XrayFA](https://github.com/Q7DF1/XrayFA) - XrayFA is a powerful and user-friendly Android client for Xray-core.
...
*   [zzc10086/TiebaLite](https://github.com/zzc10086/TiebaLite) - 贴吧 Lite

*   [lnzz123/ComboLite](https://github.com/lnzz123/ComboLite) - 🚀 为 Jetpack Compose 打造的新一代安卓插件化框架。一个现代、稳定、灵活的插件化解决方案。核心特性：原生Compose支持 | 100%官方API | 0 Hook & 0 反射 | 去中心化架构
...
*   [Kyant0/Capsule](https://github.com/Kyant0/Capsule) - Jetpack Compose smooth corners
...
*   [grtsinry43/PureFlow](https://github.com/grtsinry43/PureFlow) - kmp驱动的跨平台RSS阅读器
...
*   [yeahhe365/LLM-Web-UI](https://github.com/yeahhe365/LLM-Web-UI) - 轻量级 LLM 网页聊天界面，支持 Markdown/LaTeX 渲染、流式输出、多会话管理和多 API 配置，数据本地存储 | A lightweight web chat UI for LLMs with Markdown/LaTeX, streaming, multi-session and multi-API support. All data stored locally.
...
*   [NodePassProject/Anywhere-Android](https://github.com/NodePassProject/Anywhere-Android) -

*   [mkottman/AndroLua](https://github.com/mkottman/AndroLua) - Lua and LuaJava ported to Android

*   [dokar3/quickjs-kt](https://github.com/dokar3/quickjs-kt) - A QuickJS binding for idiomatic Kotlin, with Async/DSL/ES Modules support.
...
*   [SherlockGougou/BigImageViewPager](https://github.com/SherlockGougou/BigImageViewPager) - 🔥🔥🔥 BigImage ImageView ViewPager 一个图片/视频浏览器库，支持超大图、超长图、动图、视频，支持手势，支持查看原图、下载、加载百分比进度显示。采用区块复用加载，优化内存占用，有效避免OOM。
...
*   [710leo/uplooker](https://github.com/710leo/uplooker) - enterprise-level websites monitoring system
...
*   [HarlonWang/quickjs-wrapper](https://github.com/HarlonWang/quickjs-wrapper) - QuickJS wrapper for Android/JVM
...
*   [sjshb57/SAIR](https://github.com/sjshb57/SAIR) - Android split APKs installer

*   [duongphuhiep/justext](https://github.com/duongphuhiep/justext) - Java implementation of Content Extractor for Readability using the justext algorithm

*   [kooritea/fcmfix](https://github.com/kooritea/fcmfix) - \[xposed]让fcm唤醒已完全停止的应用

*   [msmt2017/ZeroStudio](https://github.com/msmt2017/ZeroStudio) - AndroidIDE is an IDE for Android to develop full featured Android apps.
...
*   [se-bastiaan/TorrentStream-Android](https://github.com/se-bastiaan/TorrentStream-Android) - A torrent streamer library for Android based on libtorrent4j

*   [cciradih/pcip](https://github.com/cciradih/pcip) - Preferred Cloudflare IP
...
*   [MistralMireille/MHTML-Viewer](https://github.com/MistralMireille/MHTML-Viewer) - An Android App that lets you view and save mhtml files. Uses WebView's saveWebArchive method.
...
*   [wuruxu/crwebview](https://github.com/wuruxu/crwebview) - another android webview  aar sdk  from chromium
...
*   [micronaut-projects/micronaut-rss](https://github.com/micronaut-projects/micronaut-rss) -
...
*   [code4craft/xsoup](https://github.com/code4craft/xsoup) - When jsoup meets XPath.

*   [limuyang2/CardSearchView](https://github.com/limuyang2/CardSearchView) - 🔍一个自定义搜索框
...
*   [Guolei1130/global\_httpdns](https://github.com/Guolei1130/global_httpdns) - 全局HttpDns替换方案
...
*   [songhanghang/goaway](https://github.com/songhanghang/goaway) - 远离手机 / goaway mobile  phone
...
*   [amitshekhariitbhu/AndroidTensorFlowMachineLearningExample](https://github.com/amitshekhariitbhu/AndroidTensorFlowMachineLearningExample) - Android TensorFlow MachineLearning Example (Building TensorFlow for Android)
...
*   [hustcc/placeholder.js](https://github.com/hustcc/placeholder.js) - :zap: < 1Kb library to generate image placeholders on client side

*   [isber00/heck2api4php](https://github.com/isber00/heck2api4php) - heck2api for php
...
*   [justlagom/koyebne](https://github.com/justlagom/koyebne) - 这是一个可部署在koyeb平台上的(ENC+Vision-Xhttp-ARGO)代理节点的镜像；保活项目(\_worker.js)部署至cf worker平台,通过 API token方式登录，实现账号保活
...
*   [baresip/baresip-android](https://github.com/baresip/baresip-android) - Baresip for Android
...
*   [guiqiqi/chromate](https://github.com/guiqiqi/chromate) - A new Hexo theme with full podcast support | 一款专为 Podcaster 打造的 Hexo 主题
