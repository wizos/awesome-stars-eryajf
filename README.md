...
*   [dabutaizha/juzimi](https://github.com/dabutaizha/juzimi) - 句子迷APP,MVP架构,Okhttp + Retrofit + RxJava,图片加载Glide,数据库Object-box
...
*   [sethcreate/Fruit](https://github.com/sethcreate/Fruit) - Fruit for Html just like Gson for Json.
...
*   [hjw541988478/ZfsoftCampusAssit](https://github.com/hjw541988478/ZfsoftCampusAssit) - 校园生活服务平台，集课表，成绩，校历，通知，电费，考试，图书等功能于一身的便捷效率助手。
...
*   [liangjingkanji/Net](https://github.com/liangjingkanji/Net) - \[OkHttp最佳实践] Android最好的网络请求工具, 比 Retrofit 更简单易用
...
*   [chrisbanes/Roomigrant](https://github.com/chrisbanes/Roomigrant) - Automated Android Room ORM migrations generator with compile-time code generation
...
*   [MixinNetwork/android-app](https://github.com/MixinNetwork/android-app) - 📱 Android private messenger, crypto wallet and light node to the Mixin Network
...
*   [Deteriorator/Password-Dictionaries](https://github.com/Deteriorator/Password-Dictionaries) - 收集的压缩包解压密码，包括：自己遇到的、网络采集的等
...
*   [n0raml/rsschan](https://github.com/n0raml/rsschan) - A update\&push rss/feed tool
...
*   [GoogleLLP/Archive-password-cracker](https://github.com/GoogleLLP/Archive-password-cracker) - 设计精良的压缩包密码破解工具，具有自定义字典、导出字典、选择字典等功能。基于Python实现，支持多线程与多进程，不断完善中……
...
*   [farshed/SoundSpice-mobile](https://github.com/farshed/SoundSpice-mobile) - A light-weight and minimalist music player for Android
...
*   [alexhua/Aria2-for-chrome](https://github.com/alexhua/Aria2-for-chrome) - An aria2 download task management extension for chromium based browser
...
*   [anyuzu99/heroku-miniflux](https://github.com/anyuzu99/heroku-miniflux) - one click to deploy miniflux on heroku.
